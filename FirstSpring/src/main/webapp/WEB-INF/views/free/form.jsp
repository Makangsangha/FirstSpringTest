...
<body>
	...
	<div class="container">
		<form name="newWrite"  id="boardForm"  action="/free/insert.do" class="form-horizontal" method="post">
			<c:if test="${status eq 'u' }"> 
				<input name="boNo" type="hidden" class="form-control" value="${free.boNo }">
				<input name="boWriter" type="hidden" class="form-control" value="${free.boWriter }">
			</c:if>	
			<div class="form-group row">
				<label class="col-sm-2 control-label" >제목</label>
				<div class="col-sm-5">
					<input maxlength="100" id="boTitle" name="boTitle" type="text" class="form-control" placeholder="subject" value="${free.boTitle }">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 control-label" >내용</label>
				<div class="col-sm-8">
					<textarea  maxlength="100" id="boContent" name="boContent"  cols="50" rows="5" class="form-control" placeholder="content">${free.boContent }</textarea>
				</div>
			</div>
			<div class="form-group row">
